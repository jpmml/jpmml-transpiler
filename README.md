...
* JPMML-Evaluator 1.7.7 or newer.

# Installation #

### Release versions

The current release version is **1.5.1** (4 February, 2026):
...
* `pmml-transpiler/target/pmml-transpiler-1.5-SNAPSHOT.jar` - the library JAR file.
* `pmml-transpiler-example/target/pmml-transpiler-example-executable-1.5-SNAPSHOT.jar` - the executable uber-JAR file (the library JAR file plus all its transitive dependencies).
